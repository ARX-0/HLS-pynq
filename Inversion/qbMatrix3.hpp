...
bool qbMatrix2<T>::Seperate(qbMatrix2<T> *matrix1, qbMatrix2<T> *matrix2, int colNum) {
    ...
    using qbMatrix2<T>::GetElement; //4
    using qbMatrix2<T>::SetElement; //5
